...
import {
    multipartDataRequestInterceptor
} from "@store/interceptors/requestInterceptors/multipartDataRequestInterceptor";
...
export const baseApi = createApi({
    ...
    baseQuery: getBaseQueryWithInterceptors({
        requestInterceptors: [authorizationTokenRequestInterceptor, multipartDataRequestInterceptor],
